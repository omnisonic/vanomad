...
folderDate = "2021-09-13" #date of article , same name as folder name
postPlace = "Arkansas River" # the place of this articles photos
postCategory = "Colorado" # pelican article category
postTags = "blm -, campground - , river" #pelican article tag(s) seperated by comma
